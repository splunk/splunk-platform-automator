...
SESSION_API_PARAMETERS = {
    ...
    "validate": ("config", "check_licenses", "splunk_config_aws", "agent"),
    ...
    "provision": ("extra", "confirm", "agent", "ansible_output", "native_output"),
    "destroy": ("extra", "confirm", "agent", "ansible_output", "native_output"),
    "deploy": (
        "extra",
        "verbose",
        "hosts",
        "confirm",
        "agent",
        "skip_provision_check",
        "ansible_output",
        "native_output",
    ),
    "suspend": ("confirm", "wait", "agent", "hosts", "ansible_output"),
    "resume": ("confirm", "wait", "agent", "hosts", "ansible_output"),
    "run": (
        "name",
        "extra",
        "extra_dir",
    ...
    "logs": ("run_id", "last", "follow", "ansible_output"),
    "aws": ("argv",),
