...
## 🎯 Recommended Workflow: Ansible Integration
...
This approach:
- ✅ Generates `terraform.tfvars` from your `splunk_config.yml`
- ✅ Manages Terraform lifecycle (init, plan, apply)
...
> ⚠️ **DO NOT EDIT MANUALLY** - Changes will be overwritten by the playbook.
...
> ⚠️ **Note:** Direct Terraform usage bypasses Ansible integration and won't update inventory files.
