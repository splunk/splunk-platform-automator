...
```bash
ansible-playbook ansible/aws_wait_hosts.yml
```
...
```bash
ansible-playbook ansible/aws_provision.yml --tags generate
```

### Run Terraform Init Only

```bash
ansible-playbook ansible/aws_provision.yml --tags init
```

### Run Terraform Plan Only

```bash
ansible-playbook ansible/aws_provision.yml --tags plan
```

### Auto-Approve (Skip Confirmation)

```bash
ansible-playbook ansible/aws_provision.yml -e auto_approve=true
```

### View Outputs Only

```bash
ansible-playbook ansible/aws_provision.yml --tags outputs
```
...
# DO NOT EDIT - This file is auto-generated by aws_provision.yml
